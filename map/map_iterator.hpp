...
namespace ft
{
    ...
    public:
        ...
        friend bool operator==(const tree_iterator<T1, T2> &x, const tree_iterator<T3, T2> &y);
        template <class T1, class T2, class T3>
        friend bool operator!=(const tree_iterator<T1, T2> &x, const tree_iterator<T3, T2> &y);
    };
    template <class T, class node_ptr, class T2>
    bool operator==(const tree_iterator<T, node_ptr> &x, const tree_iterator<T2, node_ptr> &y)
    {
